...
public class Resource
{
    ...
    public void printResourceDetails()
    {
        ...
        System.out.println("Resource type: "
                + (this.bIsAlgorithmicResource == true ? "algorithmic" : "non-algorithmic"));
    ...
    private void printResourceOutgoingRelations()
    {
        ...
        while (iteratorOfResourceOutgoingRelations.hasNext()) {
            System.out.println("Resource " + this.strResourceName + " has as related resource the one with id "
                    + iteratorOfResourceOutgoingRelations.next());
        }
    }
    ...
    private void printResourceIncomingRelations()
    {
        ...
        while (iteratorOfResourceIncomingRelations.hasNext()) {
            System.out.println("Resource " + this.strResourceName + " is related resource of the one with id "
                    + iteratorOfResourceIncomingRelations.next());
        }
    }
