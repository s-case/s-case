...
public class JavaResourceControllerManager
{
    ...
    public JavaResourceControllerManager(ResourceControllerManager oResourceControllerManager) {
        ...
        this.strJavaResourceControllerManagerName = String.format("Java%s",
                oResourceControllerManager.getResourceControllerManagerName());
        this.strJavaResourceControllerManagerURI = oResourceControllerManager.getResourceControllerManagerURI();
        this.oControllerManagerJAXRSAnnotation = new JAXRSAnnotation(String.format("@Path(\"%s\")",
                this.strJavaResourceControllerManagerURI));
    ...
    public void addHTTPActivities()
    {
        for (int n = 0; n < this.oPIMParentResourceControllerManager.getControllerCRUDActivities().size(); n++) {
            this.listOfJavaControllerManagerHTTPActivities.add(new HTTPActivity(
                    this.oPIMParentResourceControllerManager.getControllerCRUDActivities().get(n),
                    transformCRUDVerb(this.oPIMParentResourceControllerManager.getControllerCRUDActivities().get(n)
                            .getResourceControllerCRUDActivityVerb()), transformCRUDActivityName(
                            this.oPIMParentResourceControllerManager.getControllerCRUDActivities().get(n)
                                    .getCRUDActivityName(), this.oPIMParentResourceControllerManager
                                    .getControllerCRUDActivities().get(n).getResourceControllerCRUDActivityVerb())));
        }
    }
    ...
    public void addHTTPActivityHandlers()
    {
        for (int n = 0; n < this.oPIMParentResourceControllerManager.getControllerCRUDActivityHandlers().size(); n++) {
            this.listOfJavaControllerManagerHTTPHandlers.add(new HTTPActivityHandler(
                    this.oPIMParentResourceControllerManager.getControllerCRUDActivityHandlers().get(n),
                    transformCRUDVerb(this.oPIMParentResourceControllerManager.getControllerCRUDActivityHandlers()
                            .get(n).getCRUDActivityHandlerVerb()), transformCRUDActivityHandlerName(
                            this.oPIMParentResourceControllerManager.getControllerCRUDActivityHandlers().get(n)
                                    .getCRUDActivityHandlerName(), this.oPIMParentResourceControllerManager
                                    .getControllerCRUDActivityHandlers().get(n).getCRUDActivityHandlerVerb()), this));
        }
    }
    ...
    {
        System.out.println("The Java Resource Controller Manager: " + this.strJavaResourceControllerManagerName
                + " with related java resource model manager "
                + this.oRelatedJavaResourceModelManager.getJavaResourceModelManagerName() + " is added to PSM because "
                + this.oPIMParentResourceControllerManager.getResourceControllerManagerName() + " exists in PIM");
        System.out.println("URI: " + this.strJavaResourceControllerManagerURI);
        System.out.println("Controller Manager JAXRS @PATH Annotation: "
                + this.oControllerManagerJAXRSAnnotation.getJAXRSAnnotationText());
    ...
    public void createHibernateActivities()
    {
        HibernateController
                ...
                .add(new HibernateActivity(String.format("post%s", this.oRelatedJavaResourceModelManager
                        .getRelatedJavaResourceModel().getPIMParentResourceModel().getParentCIMResource()
                        .getResourceName()), "POST", this, null));
        ...
        if (this.oRelatedJavaResourceModelManager.getIncomingJavaModelRelations().size() > 1) {
            for (int n = 0; n < this.oRelatedJavaResourceModelManager.getIncomingJavaModelRelations().size(); n++) {
                HibernateController
                        .getHibernateControllerHandle()
                        .getControllerHibernateActivities()
                        .add(new HibernateActivity(String.format("get%s%sList", this.oRelatedJavaResourceModelManager
                                .getIncomingJavaModelRelations().get(n).getPIMParentResourceModel()
                                .getParentCIMResource().getResourceName(), this.oRelatedJavaResourceModelManager
                                .getRelatedJavaResourceModel().getPIMParentResourceModel().getParentCIMResource()
                                .getResourceName()), "GET", this, this.oRelatedJavaResourceModelManager
                                .getIncomingJavaModelRelations().get(n)));
            }
        } else {
            HibernateController
                    .getHibernateControllerHandle()
                    .getControllerHibernateActivities()
                    .add(new HibernateActivity(String.format("get%sList", this.oRelatedJavaResourceModelManager
                            .getRelatedJavaResourceModel().getPIMParentResourceModel().getParentCIMResource()
                            .getResourceName()), "GET", this, (this.oRelatedJavaResourceModelManager
                            .getIncomingJavaModelRelations().size() != 0 ? this.oRelatedJavaResourceModelManager
                            .getIncomingJavaModelRelations().get(0) : null)));
        }
    }
    ...
    {
        for (int n = 0; n < this.listOfJavaControllerManagerHTTPActivities.size(); n++) {
            if (this.listOfJavaControllerManagerHTTPActivities.get(n).getHTTPActivityVerb().equalsIgnoreCase("POST")
                    || this.listOfJavaControllerManagerHTTPActivities.get(n).getHTTPActivityVerb()
                            .equalsIgnoreCase("PUT")) {
                this.listOfJavaControllerManagerHTTPActivities.get(n).createJAXRSConsumeAnnotation(
                        this.oRelatedJavaResourceModelManager.getPIMParentResourceModelManager()
                                .getResourceInputRepresentations());
            }
            this.listOfJavaControllerManagerHTTPActivities.get(n).createJAXRSProduceAnnotaiton(
                    this.oRelatedJavaResourceModelManager.getPIMParentResourceModelManager()
                            .getResourceOutputRepresentations());
        }
    }
}
