...
import eu.fp7.scase.pimMetaModel.DatabaseController;
...
public class HibernateController
{
    ...
    {
        System.out.println("Hibernate Controller: " + this.strHibernateControllerName + " is added to PSM because "
                + oPIMParentDabaseController.getDatabaseControllerName() + " exists in PIM");
