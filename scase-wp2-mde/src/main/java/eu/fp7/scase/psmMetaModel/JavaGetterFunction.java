...
public class JavaGetterFunction
        extends JavaFunction
{
    ...
    public JavaGetterFunction(PSMComponentProperty oAccessedProperty) {
        ...
        this.setReturnParameter(new FunctionParameter("", this.oAccessedProeprty.getPSMComponentPropertyType(),
                this.oAccessedProeprty.getPSMComponentPropertyUniqueness(), true));
    }
    ...
    {
        System.out.println("The Java Getter Function: " + this.getJavaFunctionName()
                + " is added to PSM to get the value of " + this.oAccessedProeprty.getPSMComponentPropertyName()
                + " property");
