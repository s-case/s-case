...
public class JavaSetterFunction
        extends JavaFunction
{
    ...
    public JavaSetterFunction(PSMComponentProperty oJavaModelProperty, boolean isHibernatePropertySetter) {
        ...
        this.getFunctionParameters().add(
                new FunctionParameter(this.oAccessedProperty.getPSMComponentPropertyName(), this.oAccessedProperty
                        .getPSMComponentPropertyType(), this.oAccessedProperty.getPSMComponentPropertyUniqueness(),
                        false));
    ...
    {
        System.out.println("The Java Setter Function: " + this.getJavaFunctionName()
                + " is added to PSM to set the value of " + this.oAccessedProperty.getPSMComponentPropertyName()
                + " property");
