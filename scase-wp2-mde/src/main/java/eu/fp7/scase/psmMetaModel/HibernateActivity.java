...
public class HibernateActivity
{
    ...
    public HibernateActivity(String strHibernateActivityName, String strHibernateActivityVerb,
            JavaResourceController oParentJavaResourceController)
    {
    ...
    public HibernateActivity(String strHibernateActivityName, String strHibernateActivityVerb,
            JavaResourceControllerManager oParentJavaControllerManager, JavaResourceModel oIncomingJavaModel)
    {
        this.iHibernateActivityId = UniqueIdProducer.getNewUniqueId();
        this.strHibernateActivityName = strHibernateActivityName;
        this.strHibernateActivityVerb = strHibernateActivityVerb;
    ...
    {
        System.out.println("Hibernate Activity: "
                + this.strHibernateActivityName
                + " is added to PSM because "
                + (this.oParentJavaControllerManager == null ? this.oParentJavaResourceController
                        .getJavaResourceControllerName() : this.oParentJavaControllerManager
                        .getJavaResourceControllerManagerName()) + " has a " + this.strHibernateActivityVerb
                + " HTTP activity");
    }
}
