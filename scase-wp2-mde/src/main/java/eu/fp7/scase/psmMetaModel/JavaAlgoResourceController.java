...
public class JavaAlgoResourceController
{
    ...
    public void addAlgoControllerHTTPActivities()
    {
        for (int n = 0; n < this.oParentPIMAlgoResourceController.getAlgoControllerCRUDActivities().size(); n++) {
            this.listOfAlgoControllerHTTPActivities.add(new HTTPActivity(this.oParentPIMAlgoResourceController
                    .getAlgoControllerCRUDActivities().get(n), transformCRUDVerb(this.oParentPIMAlgoResourceController
                    .getAlgoControllerCRUDActivities().get(n).getResourceControllerCRUDActivityVerb()),
                    transformCRUDActivityName(this.oParentPIMAlgoResourceController.getAlgoControllerCRUDActivities()
                            .get(n).getCRUDActivityName(), this.oParentPIMAlgoResourceController
                            .getAlgoControllerCRUDActivities().get(n).getResourceControllerCRUDActivityVerb())));
        }
    }
    ...
    {
        System.out.println("The Java Algorithmic Resource Controller: " + this.strJavaAlgoResourceControllerName
                + " with related algorithmic resource model "
                + this.oRelatedAlgoResourceModel.getJavaAlgoResourceModelName() + " is added to PSM because "
                + this.oParentPIMAlgoResourceController.getAlgoResourceControllerName() + " exists in PIM");
    ...
    public void addAlgoHTTPActivityHandlers()
    {
        for (int n = 0; n < this.oParentPIMAlgoResourceController.getAlgoControllerCRUDActivityHandlers().size(); n++) {
            this.listOfAlgoControllerActivityHandlers
                    .add(new HTTPActivityHandler(this.oParentPIMAlgoResourceController
                            .getAlgoControllerCRUDActivityHandlers().get(n),
                            transformCRUDVerb(this.oParentPIMAlgoResourceController
                                    .getAlgoControllerCRUDActivityHandlers().get(n).getCRUDActivityHandlerVerb()),
                            transformCRUDActivityHandlerName(this.oParentPIMAlgoResourceController
                                    .getAlgoControllerCRUDActivityHandlers().get(n).getCRUDActivityHandlerName(),
                                    this.oParentPIMAlgoResourceController.getAlgoControllerCRUDActivityHandlers()
    ...
    {
        for (int n = 0; n < this.listOfAlgoControllerHTTPActivities.size(); n++) {
            this.listOfAlgoControllerHTTPActivities.get(n).createJAXRSConsumeAnnotation(
                    this.oRelatedAlgoResourceModel.getParentPIMAlgoResourceModel().getAlgoModelInputRepresentations());
            this.listOfAlgoControllerHTTPActivities.get(n).createJAXRSProduceAnnotaiton(
                    this.oRelatedAlgoResourceModel.getParentPIMAlgoResourceModel().getAlgoModelOutputRepresentations());
        }
    }
