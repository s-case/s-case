...
public class JavaAlgoResourceModel{
	...
	public void printJavaAlgoResourceModel(){
		System.out.println("The Java Algorithmic Resource Model: " + this.strJavaAlgoResourceModelName + " is added to PSM because " + this.oParentPIMAlgoResourceModel.getAlgoResourceModelName() + " exists in PIM");
	...
	public void addAlgoModelProperties(){
		for(int n = 0; n < this.oParentPIMAlgoResourceModel.getAlgoResourceModelProperties().size(); n++){
			this.listOfAlgoModelProperties.add(new PSMComponentProperty(this.oParentPIMAlgoResourceModel.getAlgoResourceModelProperties().get(n)));
		}
	}
	...
	public void addAlgoModelAccessFunctions(){
		for(int n = 0; n < this.listOfAlgoModelProperties.size(); n++){
			this.listOfAlgoModelSetterFunctions.add(new JavaSetterFunction(this.listOfAlgoModelProperties.get(n), false));
