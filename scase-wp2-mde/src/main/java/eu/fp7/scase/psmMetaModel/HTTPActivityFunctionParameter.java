...
public class HTTPActivityFunctionParameter
        extends FunctionParameter
{

    private JAXRSAnnotation oPathParamJAXRSAnnotation;

    public HTTPActivityFunctionParameter(String strFunctionParameterName, String strFunctionParameterType,
            boolean bIsPathParam)
    {
