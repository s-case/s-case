        ...
        extends APIMFunction
{
    ...
    public SetterFunction(PIMComponentProperty oAccessedProperty) {
        ...
        this.getFunctionParameters().add(
                new FunctionParameter(oAccessedProperty.getPIMComponentProeprtyName(), oAccessedProperty
                        .getPIMComponentPropertyType(), oAccessedProperty.getPIMComponentPropertyUniqueness(), false));
    ...
    {
        System.out.println("The setter function: " + this.getPIMFunctionName()
                + " is added to PIM to set the value of " + this.oAccessedProperty.getPIMComponentProeprtyName());
