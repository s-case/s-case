...
public class GetterFunction extends APIMFunction{
	...
	public GetterFunction(PIMComponentProperty oAccessedProperty){
		...
		this.setFunctionReturnParameter(new FunctionParameter("", oAccessedProperty.getPIMComponentPropertyType(), oAccessedProperty.getPIMComponentPropertyUniqueness(), true));
	...
	public void printPIMFunction(){
		System.out.println("The getter function: " + this.getPIMFunctionName() + " is added to PIM to get the value of " + this.oAccessedProperty.getPIMComponentProeprtyName());
