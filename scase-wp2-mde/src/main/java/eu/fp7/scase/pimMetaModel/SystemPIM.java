...
public class SystemPIM{
	...
	public void printResourceModelManagers(){
		Iterator<ResourceModelManager> iteratorOfPIMResourceModelManagers = this.listOfPIMResourceModelManagers.iterator();
	...
	public void printResourceControllerManagers(){
		Iterator<ResourceControllerManager> iteratorOfPIMResourceControllerManagers = this.listOfPIMResourceControllerManagers.iterator();
	...
	public void printAlgoResourceControllers(){
		Iterator<AlgoResourceController> iteratorOfPIMAlgoResourceControllers = this.listOfPIMAlgoResourceControllers.iterator();
