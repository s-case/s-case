...
public class ResourceModel
{
    ...
    public void addResourceInputRepresentations()
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceInputRepresentations().size(); n++) {
            this.listOfResourceInputResourceRepresentations.add(new ResourceInputRepresentation(this.oParentCIMResource
    ...
    public void addResourceOutputRepresentations()
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceOutputRepresentations().size(); n++) {
            this.listOfResourceOutputResourceRepresentations.add(new ResourceOutputRepresentation(
                    this.oParentCIMResource.getResourceOutputRepresentations().get(n)));
        }
    }

    public void printResourceModel()
    {
        System.out.println("Resource Model " + this.getResourceModelName() + " with id " + this.getResourceModelId()
                + " is added to the PIM because parent " + this.getParentCIMResource().getResourceName() + " exists");
    ...
    public void addResourceModelProperties()
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceProperties().size(); n++) {
            this.listOfResourceProperties.add(new ResourceModelProperty(this.oParentCIMResource.getResourceProperties()
                    .get(n)));
        }
    }
    ...
    private void printResourceInputRepresentations()
    {
        for (int n = 0; n < this.listOfResourceInputResourceRepresentations.size(); n++) {
            System.out.println("Input Representation: "
                    + this.listOfResourceInputResourceRepresentations.get(n).getResourceInputRepresentation());
        }
    }
    ...
    private void printResourceOutputRepresentations()
    {
        for (int n = 0; n < this.listOfResourceOutputResourceRepresentations.size(); n++) {
            System.out.println("Output Representation: "
                    + this.listOfResourceOutputResourceRepresentations.get(n).getResourceOutputRepresentation());
        }
    }
    ...
    public boolean hasRelatedModelManager(ResourceModelManager oResourceModelManager)
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceOutgoingRelations().size(); n++) {
            if (oResourceModelManager.getParentCIMResource().getResourceId() == this.oParentCIMResource
    ...
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceOutgoingRelations().size(); n++) {
            if (oAlgoResourceModel.getParentCIMResource().getResourceId() == this.oParentCIMResource
                    .getResourceOutgoingRelations().get(n)) {
                return true;
            }
        }
    ...
    private void printResourceModelRelatedResourceModelManagers()
    {
        for (int n = 0; n < this.listOfRelatedResourceModelManagers.size(); n++) {
            System.out.println("Related resource Model Manager: "
                    + this.listOfRelatedResourceModelManagers.get(n).getResourceModelManagerName());
        }
    }
    ...
    private void printRelatedAlgoResourceModels()
    {
        for (int n = 0; n < this.listOfRelatedAlgoResourceModels.size(); n++) {
            System.out.println("Related Algorithmic Resource Model: "
                    + this.listOfRelatedAlgoResourceModels.get(n).getAlgoResourceModelName());
        }
    }
    ...
    {
        this.listOfResourceProperties.add(new ResourceModelProperty(String.format("%sId",
                this.oParentCIMResource.getResourceName()), "int"));
    }
    ...
    {
        for (int n = 0; n < this.listOfResourceInputResourceRepresentations.size(); n++) {
            this.listOfResourceModelFunctions.add(new ResourceRepresentationParseFunction(this,
                    this.listOfResourceInputResourceRepresentations.get(n)));
        }
    }
    ...
    {
        for (int n = 0; n < this.listOfResourceOutputResourceRepresentations.size(); n++) {
            this.listOfResourceModelFunctions.add(new ResourceRepresentationMarshallingFunction(this,
                    this.listOfResourceOutputResourceRepresentations.get(n)));
        }
    }
    ...
    public String getModelPrimaryIdentifierName()
    {
        ...
        try {
            throw new Exception("The PIM is invalid! Could not retrieve resource model primary identifier of model "
                    + this.strResourceModelName);
        } catch (Exception e) {
            e.printStackTrace();
        }
