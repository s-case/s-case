...
public class ResourceController
{
    ...
    public ResourceController(String strResourceControllerName, Resource oParentCIMResource,
            ResourceModel oAssociatedResourceModel)
    {
        this.iResourceControllerId = UniqueIdProducer.getNewUniqueId();
    ...
    {
        System.out.println("Resource Controller " + this.getResourceControllerName() + " with id "
                + this.getResourceControllerId() + " and associated resource model "
                + this.getAssociatedResourceModel().getResourceModelName() + " is added to the PIM because "
    ...
    public void addCRUDActivities(String strCRUDActivityNamePatch, String strCRUDActivityURI,
            ResourceModel oIncomingResourceModel)
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceCRUDActivities().size(); n++) {
            // since only READ, UPDATE, DELETE activities are allowed for PIM resource controllers
            // from the meta-model
            if (this.oParentCIMResource.getResourceCRUDActivities().get(n).getActivityCRUDVerb()
                ...
                this.listOfControllerCRUDActivities
                        .add(new ResourceControllerCRUDActivity("READ", this.oParentCIMResource
                                .getResourceCRUDActivities().get(n), "read" + strCRUDActivityNamePatch
                                + this.oParentCIMResource.getResourceName(), strCRUDActivityURI, oIncomingResourceModel)); // and
                                                                                                                           // add
                                                                                                                           // one
                                                                                                                           // READ
                                                                                                                           // CRUD
                    ...
                    .equalsIgnoreCase("UPDATE")) { // check if the CRUD verb is the UPDATE one
                this.listOfControllerCRUDActivities
                        .add(new ResourceControllerCRUDActivity("UPDATE", this.oParentCIMResource
                                .getResourceCRUDActivities().get(n), "update" + strCRUDActivityNamePatch
                                + this.oParentCIMResource.getResourceName(), strCRUDActivityURI, oIncomingResourceModel)); // and
                                                                                                                           // add
                                                                                                                           // one
                                                                                                                           // UPDATE
                    ...
                    .equalsIgnoreCase("DELETE")) { // check if the CRUD verb is the DELETE one
                this.listOfControllerCRUDActivities
                        .add(new ResourceControllerCRUDActivity("DELETE", this.oParentCIMResource
                                .getResourceCRUDActivities().get(n), "delete" + strCRUDActivityNamePatch
                                + this.oParentCIMResource.getResourceName(), strCRUDActivityURI, oIncomingResourceModel)); // and
                                                                                                                           // add
                                                                                                                           // one
                                                                                                                           // DELETE
        ...
        // resource controller is satisfied
        if (this.listOfControllerCRUDActivities.size() == 0) { // if no CRUD activities where added
            try {
                throw new Exception("Error! Disatisfied PIM meta-model constraint: The resource controller "
                        + this.strResourceControllerName + " does not have any CRUD activites!");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    {
        for (int n = 0; n < this.listOfControllerCRUDActivities.size(); n++) {
            this.listOfControllerCRUDActivityHandlers.add(new CRUDActivityHandler(String.format("%sHandler",
            ...
            if (this.listOfControllerCRUDActivities.get(n).getResourceControllerCRUDActivityVerb()
                ...
                DatabaseController
                        ...
                        .add(new RDBMSActivity(this.listOfControllerCRUDActivities.get(n).getCRUDActivityName()
                                .replace("read", "select"), "SELECT", this.listOfControllerCRUDActivities.get(n)));
                ...
                DatabaseController
                        ...
                        .getDatabaseControllerActivities()
                        .add(new RDBMSActivity(this.listOfControllerCRUDActivities.get(n).getCRUDActivityName()
                                .replace("update", "update"), "UPDATE", this.listOfControllerCRUDActivities.get(n)));
            } else if (this.listOfControllerCRUDActivities.get(n).getResourceControllerCRUDActivityVerb()
                ...
                DatabaseController
                        ...
                        .getDatabaseControllerActivities()
                        .add(new RDBMSActivity(this.listOfControllerCRUDActivities.get(n).getCRUDActivityName()
                                .replace("delete", "delete"), "DELETE", this.listOfControllerCRUDActivities.get(n)));
            }
        }
    }
    ...
    {
        for (int n = 0; n < this.listOfControllerCRUDActivityHandlers.size(); n++) {
            if (this.hasReadActivity()
                    && !this.listOfControllerCRUDActivityHandlers.get(n).getCRUDActivityHandlerVerb()
                            .equalsIgnoreCase("DELETE")) {
            ...
            if (this.hasUpdateActivity()
                    && !this.listOfControllerCRUDActivityHandlers.get(n).getCRUDActivityHandlerVerb()
                            .equalsIgnoreCase("DELETE")) {
                this.listOfControllerCRUDActivityHandlers.get(n).getHypermediaFunction().getHypermediaLinkList()
                        .add(new PIMHypermediaLink("UPDATE", "Sibling", this));
            }
            ...
            if (this.hasDeleteActivity()
                    && !this.listOfControllerCRUDActivityHandlers.get(n).getCRUDActivityHandlerVerb()
                            .equalsIgnoreCase("DELETE")) {
                this.listOfControllerCRUDActivityHandlers.get(n).getHypermediaFunction().getHypermediaLinkList()
                        .add(new PIMHypermediaLink("DELETE", "Sibling", this));
            }
        }
    }
    ...
    {
        for (int n = 0; n < this.listOfControllerCRUDActivityHandlers.size(); n++) {
            if (!this.listOfControllerCRUDActivityHandlers.get(n).getCRUDActivityHandlerVerb()
                    .equalsIgnoreCase("DELETE")) {
                this.listOfControllerCRUDActivityHandlers.get(n).getHypermediaFunction().getHypermediaLinkList()
                        .add(new PIMHypermediaLink("READ", "Children", oChildResourceControllerManager));
            }

            if (!this.listOfControllerCRUDActivityHandlers.get(n).getCRUDActivityHandlerVerb()
                    .equalsIgnoreCase("DELETE")) {
                this.listOfControllerCRUDActivityHandlers.get(n).getHypermediaFunction().getHypermediaLinkList()
                        .add(new PIMHypermediaLink("CREATE", "Children", oChildResourceControllerManager));
            }
        }
    }
        ...
        for (int n = 0; n < this.listOfControllerCRUDActivityHandlers.size(); n++) {
            if (!this.listOfControllerCRUDActivityHandlers.get(n).getCRUDActivityHandlerVerb()
                ...
                this.listOfControllerCRUDActivityHandlers
                        ...
                        .add(new PIMHypermediaLink(oChildAlgoResourceController.getAlgoControllerCRUDActivities()
                                .get(0).getResourceControllerCRUDActivityVerb(), "Children",
                                oChildAlgoResourceController));
            }
        }
    }
    ...
    public void createParentHypermediaLinks(ResourceControllerManager oParentResourceControllerMangaer)
    {
        for (int n = 0; n < this.listOfControllerCRUDActivityHandlers.size(); n++) {
            this.listOfControllerCRUDActivityHandlers.get(n).getHypermediaFunction().getHypermediaLinkList()
                    .add(new PIMHypermediaLink("READ", "Parent", oParentResourceControllerMangaer));
            this.listOfControllerCRUDActivityHandlers.get(n).getHypermediaFunction().getHypermediaLinkList()
                    .add(new PIMHypermediaLink("CREATE", "Parent", oParentResourceControllerMangaer));
        }
    }
