...
public class ResourceModelProperty
        extends PIMComponentProperty
{

    private boolean bIsNamingProperty;
    private boolean bIsPrimaryIdentifier;

    public ResourceModelProperty(Property oResourceProperty) { // constructor used to build a PIM
                                                               // property that is corresponding to
                                                               // a CIM one
    ...
    public void printResourceModelProperty()
    {
        ...
        System.out.println("Property naming ability: "
                + (this.bIsNamingProperty == true ? "It is naming property" : "It is not naming property"));
        System.out.println("Property identifying ability: "
