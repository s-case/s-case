...
public class RDBMSActivity{
	...
	public RDBMSActivity(String strRDBMSActivityName, String strRDBMSActivityVerb, ResourceControllerCRUDActivity oParentCRUDActivity){
	...
	public void printRDBMSActivity(){
		System.out.println("RDBMS Activity: " + this.strRDBMSActivityName + " is added to PIM because " + this.oParentCRUDActivity.getCRUDActivityName() + " exists");
	}
}