...
public class ResourceControllerCRUDActivity{
	...
	private ResourceModel oIncomingResourceModel; //bad name, it refers to the resource model of which this one is related resource
	
	public ResourceControllerCRUDActivity(String strActivityCRUDVerb, String strCRUDActivityName, String strCRUDActivityURI){
	...
	public ResourceControllerCRUDActivity(String strActivityCRUDVerb, String strCRUDActivityName, String strCRUDActivityURI, ResourceModel oIncomingResourceModel){
		this.iResourceControllerCRUDActivityId = UniqueIdProducer.getNewUniqueId();
		this.strActivityCRUDVerb = strActivityCRUDVerb;
		this.strCRUDActivityName = strCRUDActivityName;
		this.strCRUDActivityURI = strCRUDActivityURI;
	...
	public ResourceControllerCRUDActivity(String strActivityCRUDVerb, CRUDActivity oParentCRUDActivity, String strCRUDActivityName, String strCRUDActivityURI, ResourceModel oIncomingResourceModel){
		this.iResourceControllerCRUDActivityId = UniqueIdProducer.getNewUniqueId();
		this.strActivityCRUDVerb = strActivityCRUDVerb;
