...
public class ResourceModelManager{
	...
	public ResourceModelManager(String strResourceModelManagerName, Resource oParentCIMResource, ResourceModel oRelatedResourceModel){
		this.iResourceModelManagerId = UniqueIdProducer.getNewUniqueId();
	...
	public void addResourceInputRepresentations(){
		for(int n = 0; n < oParentCIMResource.getResourceInputRepresentations().size(); n++){
			this.listOfResourceModelInputRepresentations.add(new ResourceInputRepresentation(oParentCIMResource.getResourceInputRepresentations().get(n)));
		}
	...
	public void addResourceOutputRepresentations(){
		for(int n = 0; n < oParentCIMResource.getResourceOutputRepresentations().size(); n++){
			this.listOfResourceModelOutputRepresentations.add(new ResourceOutputRepresentation(oParentCIMResource.getResourceOutputRepresentations().get(n)));
		}
	...
	public void printResourceModelManager(){
		System.out.println("Resource Model manager " + this.getResourceModelManagerName() + " with id " + this.getResourceModelManagerId() + " and related resource model " + this.getRelatedResourceModel().getResourceModelName() + " is added to the PIM because " + this.getParentCIMResource().getResourceName() + " exists");
	...
	private void printResourceInputRepresentations(){
		for(int n = 0; n < this.listOfResourceModelInputRepresentations.size(); n++){
			System.out.println("Input Representation: " + this.listOfResourceModelInputRepresentations.get(n).getResourceInputRepresentation());
		}
	}
	
	private void printResourceOutputRepresentations(){
		for(int n = 0; n < this.listOfResourceModelOutputRepresentations.size(); n++){
			System.out.println("Output Representation: " + this.listOfResourceModelOutputRepresentations.get(n).getResourceOutputRepresentation());
		}
	}
	...
	public void addPropertyAccessFunctions(){
		for(int n = 0; n < this.listOfResourceModelManagerProperties.size(); n++){
			this.listOfResourceModelManagerFunctions.add(new SetterFunction(this.listOfResourceModelManagerProperties.get(n)));
			this.listOfResourceModelManagerFunctions.add(new GetterFunction(this.listOfResourceModelManagerProperties.get(n)));
		}
	}
	...
	public void addRepresentationUnmarshallingFunctions(){
		for(int n = 0; n < this.listOfResourceModelInputRepresentations.size(); n++){
			this.listOfResourceModelManagerFunctions.add(new ResourceRepresentationParseFunction(this.oRelatedResourceModel, this.listOfResourceModelInputRepresentations.get(n)));
		}
	}
	
	public void addRepresentationMarshallingFunctions(){
		for(int n = 0; n < this.listOfResourceModelOutputRepresentations.size(); n++){
			this.listOfResourceModelManagerFunctions.add(new ResourceRepresentationMarshallingFunction(this.oRelatedResourceModel, this.listOfResourceModelOutputRepresentations.get(n)));
		}
	}
}
