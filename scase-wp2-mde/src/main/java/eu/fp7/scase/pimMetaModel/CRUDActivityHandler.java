...
public class CRUDActivityHandler
{
    ...
    private ResourceModel oIncomingResourceModel; // see explanation at the according property of
    ...
    public CRUDActivityHandler(String strCRUDActivityHandlerName, String strCRUDActivityHandlerVerb,
            ResourceControllerCRUDActivity oParentControllerCRUDActivity, ResourceController oParentResourceController)
    {
        this.iCRUDActivityHandlerId = UniqueIdProducer.getNewUniqueId();
        ...
        this.oCreateHypermediaPIMFunction = new CreateHypermediaPIMFunction(this, this.oParentResourceController,
                oParentControllerCRUDActivity);
    }

    public CRUDActivityHandler(String strCRUDActivityHandlerName, String strCRUDActivityHandlerVerb,
            ResourceControllerCRUDActivity oParentControllerCRUDActivity,
            ResourceControllerManager oParentResourceControllerManager)
    {
        this.iCRUDActivityHandlerId = UniqueIdProducer.getNewUniqueId();
        this.strCRUDActivityHandlerName = strCRUDActivityHandlerName;
        this.strCRUDActivityHandlerVerb = strCRUDActivityHandlerVerb;
        ...
        this.oCreateHypermediaPIMFunction = new CreateHypermediaPIMFunction(this,
                this.oParentResourceControllerManager, oParentControllerCRUDActivity);
    }

    public CRUDActivityHandler(String strCRUDActivityHandlerName, String strCRUDActivityHandlerVerb,
            ResourceControllerCRUDActivity oParentControllerCRUDActivity,
            ResourceControllerManager oParentResourceControllerManager, ResourceModel oIncomingResourceModel)
    {
        this.iCRUDActivityHandlerId = UniqueIdProducer.getNewUniqueId();
        this.strCRUDActivityHandlerName = strCRUDActivityHandlerName;
        this.strCRUDActivityHandlerVerb = strCRUDActivityHandlerVerb;
        ...
        this.oCreateHypermediaPIMFunction = new CreateHypermediaPIMFunction(this,
                this.oParentResourceControllerManager, oParentControllerCRUDActivity, oIncomingResourceModel);
    }

    public CRUDActivityHandler(String strCRUDActivityHandlerName, String strCRUDActivityHandlerVerb,
            ResourceControllerCRUDActivity oParentControllerCRUDActivity, AlgoResourceController oParentAlgoController)
    {
        this.iCRUDActivityHandlerId = UniqueIdProducer.getNewUniqueId();
        this.strCRUDActivityHandlerName = strCRUDActivityHandlerName;
        this.strCRUDActivityHandlerVerb = strCRUDActivityHandlerVerb;
        ...
        this.oCreateHypermediaPIMFunction = new CreateHypermediaPIMFunction(this, this.oParentAlgoResourceController,
                oParentControllerCRUDActivity);
    }
    ...
    {
        System.out
                .println(this.strCRUDActivityHandlerName
                        + " is added to the PIM because "
                        + (this.oParentResourceController == null ? (this.oParentAlgoResourceController == null ? this.oParentResourceControllerManager
                                .getResourceControllerManagerName() : this.oParentAlgoResourceController
                                .getAlgoResourceControllerName())
                                : this.oParentResourceController.getResourceControllerName()) + " has a "
                        + this.strCRUDActivityHandlerVerb + " activity");
