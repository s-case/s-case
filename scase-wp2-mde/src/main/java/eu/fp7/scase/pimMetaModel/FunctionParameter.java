...
public class FunctionParameter{
	...
	public FunctionParameter(String strFunctionParameterName, String strFunctionParameterType, boolean bIsUnique, boolean bIsReturnParameter){
	...
	public void printFunctionParameter(){
		...
		System.out.println("Function Parameter Type: " + (this.bIsReturnParameter == true? "Return Parameter" : "Input Parameter"));
	}
