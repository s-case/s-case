...
public class AlgoResourceModel
{
    ...
    {
        System.out.println("Resource Algorithmic Model " + this.getAlgoResourceModelName() + " with id "
                + this.getAlgoResourceModelId() + " is added in the PIM because "
    ...
    public void addResourceInputRepresentations()
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceOutputRepresentations().size(); n++) {
            this.listOfResourceInputRepresentations.add(new ResourceInputRepresentation(this.oParentCIMResource
    ...
    {
        for (int n = 0; n < this.oParentCIMResource.getResourceOutputRepresentations().size(); n++) {
            this.listOfResourceOutputRepresentations.add(new ResourceOutputRepresentation(this.oParentCIMResource
    ...
    public void printResourceInputRepresentations()
    {
        for (int n = 0; n < this.listOfResourceInputRepresentations.size(); n++) {
            System.out.println("Input Representation: "
                    + this.listOfResourceInputRepresentations.get(n).getResourceInputRepresentation());
        }
    }
    ...
    public void printResourceOutputRepresentations()
    {
        for (int n = 0; n < this.listOfResourceOutputRepresentations.size(); n++) {
            System.out.println("Output Representation: "
                    + this.listOfResourceOutputRepresentations.get(n).getResourceOutputRepresentation());
        }
    }
    ...
    {
        for (int n = 0; n < this.listOfResourceInputRepresentations.size(); n++) {
            this.listOfAlgoResourceModelFunctions.add(new ResourceRepresentationParseFunction(this,
                    this.listOfResourceInputRepresentations.get(n)));
        }
    }
    ...
    {
        for (int n = 0; n < this.listOfResourceOutputRepresentations.size(); n++) {
            this.listOfAlgoResourceModelFunctions.add(new ResourceRepresentationMarshallingFunction(this,
                    this.listOfResourceOutputRepresentations.get(n)));
        }
    }
