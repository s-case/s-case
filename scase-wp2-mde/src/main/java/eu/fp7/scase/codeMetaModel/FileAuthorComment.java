...
public class FileAuthorComment{
	...
	public String exportFileAuthorComment(){
		return (strOrganizationStamp + this.strProject + this.strWorkFile + this.strCompiler + this.strFileDescription + this.strDocumentDescription + this.strRelatedDocuments + this.strNote + strProgrammer + strContact);
	}
}