...
public class AlgoResourceModelJavaFile extends AJavaFile{
	...
	public AlgoResourceModelJavaFile(JavaAlgoResourceModel oParentAlgoJavaModel, String strProjectName, String strPackageStamp){
	...
	public void printJavaFile(){
		System.out.println("The Java Algorithmic Model File: " + this.getJavaFileName() + " is added to the software code project because " + this.oParentAlgoJavaModel.getJavaAlgoResourceModelName() + " exists in PSM");
	}
