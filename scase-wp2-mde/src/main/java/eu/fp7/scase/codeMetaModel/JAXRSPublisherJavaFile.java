...
public class JAXRSPublisherJavaFile extends AJavaFile{
	...
	public JAXRSPublisherJavaFile(String strFileName, String strProjectName, String strPackageStamp, ArrayList<JavaResourceController> listControllers, ArrayList<JavaResourceControllerManager> listControllerManagers, ArrayList<JavaAlgoResourceController> listAlgoControllers){
	...
	public void printJavaFile(){
		System.out.println("The JAXRS Publisher File: " + this.getJavaFileName() + " is added to the software code project because it set ups the configuration of the service during deployment");
	}
