...
public class JavaPackage
{
    ...
    public JavaPackage(Resource oParentResource, String strProjectName, String strFileSystemPath) {
        ...
        this.strJavaPackageStamp = String.format("package src.main.java.%s.%s;", strProjectName.toLowerCase(),
                this.strJavaPackageName.toLowerCase());
    ...
    {
        System.out
                .println("The Java Package: "
                        + this.strJavaPackageName
                        + " is added to the software project system because "
                        + (this.strJavaPackageName.equalsIgnoreCase("Utilities") ? " because every software code project must have exactly one Utilities package"
                                : (this.strJavaPackageName + " resource exists in CIM")));
