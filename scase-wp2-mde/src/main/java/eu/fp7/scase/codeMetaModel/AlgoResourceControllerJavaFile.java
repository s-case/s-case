...
public class AlgoResourceControllerJavaFile
        extends AJavaFile
{

    private JavaAlgoResourceController oParentJavaController;

    public AlgoResourceControllerJavaFile(JavaAlgoResourceController oParentJavaController, String strProjectName,
    ...
    {
        System.out.println("This Java Algorithmic Controller File: " + this.getJavaFileName()
                + " is added to software code project because "
                + this.oParentJavaController.getJavaAlgoResourceControllerName() + " exists in PSM");
    }
    ...
    public String addClassHeader()
    {
        this.strClassHeader = String.format("%s%spublic class %s{%n", this.strClassHeader,
                ...
                this.oParentJavaController.getJavaAlgoResourceControllerName());
