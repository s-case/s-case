...
import storyboards.diagram.providers.ElementInitializers;
...
public class StoryboardsDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "Storyboards.diagram"; //$NON-NLS-1$
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, StoryboardsDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, StoryboardsDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
