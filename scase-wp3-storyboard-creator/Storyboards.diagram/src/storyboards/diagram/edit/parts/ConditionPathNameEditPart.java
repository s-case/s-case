...
import storyboards.diagram.edit.policies.StoryboardsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConditionPathNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StoryboardsVisualIDRegistry.getType(storyboards.diagram.edit.parts.ConditionPathNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ConditionPathNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new StoryboardsTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return StoryboardsElementTypes.getImage(parserElement.eClass());
	}
		...
		if (parser == null) {
			parser = StoryboardsParserProvider.getParser(StoryboardsElementTypes.ConditionPath_4001,
					getParserElement(), StoryboardsVisualIDRegistry
							.getType(storyboards.diagram.edit.parts.ConditionPathNameEditPart.VISUAL_ID));
		}
		return parser;
	}
