 ...
 * @generated
 */
public class ConditionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConditionNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = StoryboardsParserProvider
					.getParser(StoryboardsElementTypes.Condition_2010, getParserElement(), StoryboardsVisualIDRegistry
							.getType(storyboards.diagram.edit.parts.ConditionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
