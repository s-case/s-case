 ...
 * @generated
 */
public class ActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = StoryboardsParserProvider.getParser(StoryboardsElementTypes.Action_2006, getParserElement(),
					StoryboardsVisualIDRegistry.getType(storyboards.diagram.edit.parts.ActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
