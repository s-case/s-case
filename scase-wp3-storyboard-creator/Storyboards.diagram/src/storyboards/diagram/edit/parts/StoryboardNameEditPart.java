 ...
 * @generated
 */
public class StoryboardNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StoryboardNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = StoryboardsParserProvider.getParser(StoryboardsElementTypes.Storyboard_2012, getParserElement(),
					StoryboardsVisualIDRegistry
							.getType(storyboards.diagram.edit.parts.StoryboardNameEditPart.VISUAL_ID));
		}
		return parser;
	}
