...
import storyboards.diagram.edit.policies.ActionItemSemanticEditPolicy;
...
public class ActionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionNameEditPart) {
			((ActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(StoryboardsVisualIDRegistry.getType(ActionNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ActionFigure extends Ellipse {
		...
		public ActionFigure() {
			...
			this.setMinimumSize(new Dimension(getMapMode().DPtoLP(70), getMapMode().DPtoLP(40)));
			createContents();
		...
		private void createContents() {
			...
			fFigureActionNameFigure.setAlignment(PositionConstants.CENTER);
