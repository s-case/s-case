...
import storyboards.diagram.edit.policies.EndNodeItemSemanticEditPolicy;
...
public class EndNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EndNodeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EndNodeFigure();
	}
	 ...
	 * @generated
	 */
	public class EndNodeFigure extends CircleShape {
