 ...
 * @generated
 */
public class StartNodePreconditionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StartNodePreconditionEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = StoryboardsParserProvider.getParser(StoryboardsElementTypes.StartNode_2007, getParserElement(),
					StoryboardsVisualIDRegistry
							.getType(storyboards.diagram.edit.parts.StartNodePreconditionEditPart.VISUAL_ID));
		}
		return parser;
	}
