 ...
 * @generated
 */
public class ActionNodeNextNodeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionNodeNextNodeCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return StoryboardsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateActionNodeNextNode_4006(getSource(),
				getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setNextNode(getTarget());
		}
