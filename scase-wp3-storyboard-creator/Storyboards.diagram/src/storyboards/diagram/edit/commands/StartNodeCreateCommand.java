...
public class StartNodeCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		StoryboardDiagram container = (StoryboardDiagram) getElementToEdit();
		if (container.getStoryboardstartnode() != null) {
			return false;
		}
		return true;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		StartNode newElement = StoryboardsFactory.eINSTANCE.createStartNode();

		StoryboardDiagram owner = (StoryboardDiagram) getElementToEdit();
		owner.setStoryboardstartnode(newElement);
