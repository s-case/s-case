 ...
 * @generated
 */
public class StartNodeItemSemanticEditPolicy extends StoryboardsBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public StartNodeItemSemanticEditPolicy() {
		super(StoryboardsElementTypes.StartNode_2007);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (StoryboardsVisualIDRegistry.getVisualID(outgoingLink) == StartNodeFirstNodeEditPart.VISUAL_ID) {
