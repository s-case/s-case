 ...
 * @generated
 */
public class PropertyItemSemanticEditPolicy extends StoryboardsBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PropertyItemSemanticEditPolicy() {
		super(StoryboardsElementTypes.Property_2008);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (StoryboardsVisualIDRegistry.getVisualID(incomingLink) == ActionPropertiesEditPart.VISUAL_ID) {
