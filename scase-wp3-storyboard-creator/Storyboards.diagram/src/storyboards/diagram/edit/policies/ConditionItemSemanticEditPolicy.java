 ...
 * @generated
 */
public class ConditionItemSemanticEditPolicy extends StoryboardsBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ConditionItemSemanticEditPolicy() {
		super(StoryboardsElementTypes.Condition_2010);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (StoryboardsVisualIDRegistry.getVisualID(outgoingLink) == ConditionPathEditPart.VISUAL_ID) {
