...
public class StoryboardsActionBarContributor extends EditingDomainActionBarContributor implements
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("storyboards-settings"));
		toolBarManager.add(new Separator("storyboards-additions"));
	}
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(StoryboardsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(StoryboardsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
