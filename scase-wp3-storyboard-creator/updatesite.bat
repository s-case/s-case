...
:: e.g. C:\Users\user\git\s-case and C:\Users\user\git\s-case.github.io
...
xcopy ..\s-case\scase-wp3-storyboard-creator\StoryboardPluginUpdateSite\target\site s-case_update_site\ /s /e /Y
