...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	protected EClass eStaticClass() {
		return StoryboardsPackage.Literals.PROPERTY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoryboardsPackage.PROPERTY__NAME, oldName, name));
	}
		...
		if (diagnostic != null) {
			if (getName().equals("")) {
				...
				diagnostic.add(new BasicDiagnostic(Diagnostic.ERROR, StoryboardsValidator.DIAGNOSTIC_SOURCE,
						StoryboardsValidator.PROPERTY__VALIDATE, "There is a property with no name!",
						new Object[] { this }));
			}
		}
		return valid;
