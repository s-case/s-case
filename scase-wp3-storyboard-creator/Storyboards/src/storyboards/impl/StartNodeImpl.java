...
public class StartNodeImpl extends NodeImpl implements StartNode {
	...
	public void setPrecondition(String newPrecondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StoryboardsPackage.START_NODE__PRECONDITION, oldPrecondition, precondition));
	}
	...
	public Node getFirstNode() {
		if (firstNode != null && firstNode.eIsProxy()) {
			...
			if (firstNode != oldFirstNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StoryboardsPackage.START_NODE__FIRST_NODE, oldFirstNode, firstNode));
			}
		}
		return firstNode;
	}
