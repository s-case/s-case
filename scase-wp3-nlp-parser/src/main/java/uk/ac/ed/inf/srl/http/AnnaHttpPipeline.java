        ...
        extends AbstractPipeline
{
    ...
    private static final String STYLESHEET = "<style type=\"text/css\">%n" + "  table { background-color:#000000 }%n"
            ...
            + "  .topRowCell {border-bottom: 1px solid black}%n" + "</style>%n";
    ...
    {
        String s = "  <h3>Try the parsing pipeline</h3>%n" + "  Enter a sentence in <b>"
    ...
    private String getHTMLResponse(Sentence sen, long time, boolean includeDependencyGraphImage)
    {
        ...
        /*
         * if(includeDependencyGraphImage){ try { ByteArrayOutputStream
            ...
            throws IOException
    {
        ...
        AnnaHttpPipeline ahp = new AnnaHttpPipeline(pp, HttpPipeline.imageCache, options.l, options.sentenceMaxLength,
                options);
