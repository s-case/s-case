...
public abstract class ContinuousFeature
        extends Feature
{
    private static final long serialVersionUID = 1L;

    protected ContinuousFeature(FeatureName name, boolean includeArgs, boolean usedForPredicateIdentification,
            String POSPrefix)
    {
    ...
    /**
     * This method works with features that have includeArgs==false. It extracts either from all
     * words (if boolean allWords is true), or from the predicates only (if false)
     */
    @Override
