    ...
    public void extractSense(Predicate p)
    {
        ...
        for (String prefix : POSPrefixes) {
            if (predPOS.startsWith(prefix)) {
                map.get(prefix).add("all", p.getSense());
                return;
            }
        }
