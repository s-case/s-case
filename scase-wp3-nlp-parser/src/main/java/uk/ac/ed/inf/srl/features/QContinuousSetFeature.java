...
public class QContinuousSetFeature extends SetFeature implements QuadraticFeature {
	private static final long serialVersionUID = 1L;
	
	private ContinuousFeature f1;
	private SetFeature f2;
	
	protected QContinuousSetFeature(ContinuousFeature f1,SetFeature f2,boolean usedForPredicateIdentification,String POSPrefix) {
