...
//	}
	...
	@Override
	public void addInstance(int label, Collection<Integer> indices, Map<Integer, Double> nonbinFeats) {
		out.print(label);
		out.print(' ');
	...
	private static abstract class ProblemWriter {
	    ...
	    abstract void writeIndices(Collection<Integer> indices, Map<Integer, Double> nonbinFeats);
	}
	private static class HistogramProblemWriter extends ProblemWriter{
		...
		@Override
		void writeIndices(Collection<Integer> indices, Map<Integer, Double> nonbinFeats) {
	...
	private static class BinaryProblemWriter extends ProblemWriter{
		...
		@Override
		    public void writeIndices(Collection<Integer> indices, Map<Integer, Double> nonbinFeats) {
			...
			for(Integer index:nonbinFeats.keySet()){
			    out.print(index);
			    out.print(":");
			    out.print(nonbinFeats.get(index));
			    out.print(" ");
			}
		}
