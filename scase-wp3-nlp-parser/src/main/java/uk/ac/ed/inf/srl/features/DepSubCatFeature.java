        ...
        extends SingleFeature
{
    ...
    private String makeFeatureString(Sentence s, Set<Word> children)
    {
        ...
        case 0:
            return " "; // This is the String corresponding to 0 children. Yet this should not be
                        // ignored as a feature which it would by the addMap() method if it would
                        // return the empty string or null. Not really sure if this is optimal, or
