...
public class Preprocessor
{
    ...
    public Preprocessor(Tokenizer tokenizer, Lemmatizer lemmatizer, Tagger tagger, is2.mtag.Tagger mtagger,
            Parser parser)
    {
    ...
    /**
     * Executes all loaded components on this SentenceData09 object. It is assumed to have the forms
     * filled out only
     * 
    ...
    private SentenceData09 preprocess(SentenceData09 instance)
    {
        ...
        } else { // If there is no parser, we have to recreate the sentence object so the root dummy
                 // gets thrown out (as in the parser)
