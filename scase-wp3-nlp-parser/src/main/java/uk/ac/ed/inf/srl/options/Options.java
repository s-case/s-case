...
public abstract class Options
{
    ...
    protected void superParseCmdLine(String[] args)
    {
        ...
        ai++;
        while (ai < args.length) { // First we try to parse the common options. If none are found,
                                   // then we try the specialized methods for Learn and Parse (ie
                                   // the abstract parseCmdLine method)
