        ...
        implements HttpHandler
{
    ...
    {
        /*
         * It would be nice to not assume UTF8 below, but I don't know how to do that. Maybe
         * escaping is actually done with HTML escapes. I should read up on this. For now I leave it
         * like this.
         */
    ...
    protected void sendContent(HttpExchange exchange, String content, String content_type, int responseCode)
            throws IOException
    {
