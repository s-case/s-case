        ...
        implements PipelineStep
{
    ...
    public void prepareLearning(String filePrefix)
    {
        ...
        for (String POS : featureSet.POSPrefixes) {
            ...
            learningProblems.put(POS, new LibLinearLearningProblem(dataFile, false));
        }
    }
    ...
    static void readModels(ZipFile zipFile, Map<String, Model> models, String filename)
            throws IOException, ClassNotFoundException
    {
    ...
    static void writeModels(ZipOutputStream zos, Map<String, Model> models, String filename)
            throws IOException
    {
