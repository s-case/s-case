...
public class BrownPathFeature extends SingleFeature {
	...
	protected BrownPathFeature(FeatureName name,boolean consider_deptree, BrownCluster bc, ClusterVal cv, String POSPrefix) {
