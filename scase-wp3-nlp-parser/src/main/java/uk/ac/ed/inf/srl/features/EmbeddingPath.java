...
public class EmbeddingPath extends ContinuousFeature{
	...
	protected EmbeddingPath(FeatureName name,TargetWord tw, String POSPrefix, boolean syntax, WordEmbedding bc,int dim) {
    ...
    public Double getDepBasedFeatureValue(Sentence s, int predIndex, int argIndex)
    {
    	double ret = 0.0;
    ...
    public Double getFeatureValue(Predicate pred, Word arg) {
        	return getFeatureValue(pred.getMySentence(), pred.getIdx(), arg.getIdx());    	
    }
