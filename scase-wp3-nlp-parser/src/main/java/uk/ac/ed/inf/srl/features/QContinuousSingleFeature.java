...
public class QContinuousSingleFeature extends Feature implements QuadraticFeature {
    private static final long serialVersionUID = 1L;
	
    private ContinuousFeature f1;
    private SingleFeature f2;
    
    protected QContinuousSingleFeature(ContinuousFeature f1,SingleFeature f2,boolean usedForPredicateIdentification,String POSPrefix) {
	...
	String ret = f1.getFeatureString(s, predIndex, argIndex)+VALUE_SEPARATOR+f2.getFeatureString(s, predIndex, argIndex);
	...
	String ret = f1.getFeatureString(pred, arg)+VALUE_SEPARATOR+f2.getFeatureString(pred, arg);
	//System.err.println(ret);
	return ret;
    }
