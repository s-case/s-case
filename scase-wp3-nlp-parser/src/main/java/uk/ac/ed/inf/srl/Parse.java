            ...
            throws Exception
    {
        ...
        if (parseOptions.useReranker) {
            ...
            srl = parseOptions.skipPD ? Pipeline.fromZipFile(zipFile, new Step[] { Step.ai, Step.ac })
                    : parseOptions.skipPI ? Pipeline.fromZipFile(zipFile, new Step[] { Step.pd, Step.ai, Step.ac /*
                                                                                                                  * ,
                                                                                                                  * Step
                                                                                                                  * .
                                                                                                                  * po
        ...
        SentenceReader reader = parseOptions.skipPI ? new SRLOnlyCoNLL09Reader(parseOptions.inputCorpus)
