        ...
        extends SingleFeature
{
    ...
    /*
     * Position is the position of the argument wrt the predicate. I.e. if the predicate is at
     * position 2, and the argument at position 4, their relation is AFTER
     */
