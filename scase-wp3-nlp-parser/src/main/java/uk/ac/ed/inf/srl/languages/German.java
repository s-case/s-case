        ...
        extends Language
{
    ...
    { // TODO this could be done nicer... I guess the proper way would be to create an enum of all
      // the modules in the complete pipeline, and let each language enumerate which modules it
      // requires. Then the language class can handle the verification, and not every subclass.
        File[] files;
        files = new File[2];
