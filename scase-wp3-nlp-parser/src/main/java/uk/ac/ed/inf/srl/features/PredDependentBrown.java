...
public class PredDependentBrown extends PredDependentAttrFeature{
	...
	protected PredDependentBrown(FeatureName name,TargetWord tw, boolean includeAllWords,String POSPrefix,BrownCluster bc,ClusterVal cv) {
