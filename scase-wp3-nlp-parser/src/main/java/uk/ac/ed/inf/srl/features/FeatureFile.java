...
public class FeatureFile
{
            ...
            throws IOException
    {
        ...
        while ((line = in.readLine()) != null) {
            if (line.startsWith("#")) {
                ...
                prefix = null; // Set prefix to null, next line should contain a POS-tag
                array = null;
            } else { // Else this is a feature to be added to the current array
                String name;
                if (line.contains(" ")) { // Only consider the first word on the line
    ...
    public static void writeToFile(List<Feature> features, String POSPrefix, List<String> comments, File file)
