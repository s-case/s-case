        ...
        implements Serializable
{
    ...
    private void populateCluster(BufferedReader reader, int shortLen, int threshold)
            throws IOException
    {
        int sInd = 1;
        int lInd = 1;
        ...
        while ((line = reader.readLine()) != null) {
            ...
            Integer _short = Integer
                    .parseInt(cols[0].length() > shortLen ? cols[0].substring(0, shortLen) : cols[0], 2);
    ...
    private void read(DataInput input)
            throws IOException
    {
            ...
            throws IOException
    {
        ...
        String[] examples = { "believe", "hello", "hi", "bye", "banana", "apple", "pepsi", "beer", "wine", "water",
                "asasfasfaf", "drink", "eat", "ate", "drank", "drunk", "eaten", "devour" };
