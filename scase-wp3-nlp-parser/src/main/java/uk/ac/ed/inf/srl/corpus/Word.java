...
public class Word implements Serializable{
	...
	public static enum WordData { Form, Lemma, POS, Deprel, Pred, OntPred, HMM/*, UniversalPOS*/ };
	...
	/** Map POS to universal POS tagset **
	private String universal(String s) {
		if(s.equals("DT") || s.equals("EX") || s.equals("PDT") || s.equals("WDT"))
			return "DET";
		else if(s.equals("FW") || s.equals("LS") || s.equals("RN") || s.equals("SYM") || s.equals("UH") || s.equals("WH"))
			return "X";
		else if(s.startsWith("J"))
			return "ADJ";
		else if(s.equals("MD") || s.startsWith("V"))
			return "VERB";
		else if(s.startsWith("N"))
			return "NOUN";
		else if(s.equals("POS") || s.equals("RP") || s.equals("PRT") || s.equals("TO"))
			return "PRT";
		else if(s.startsWith("P") || s.startsWith("WP"))
			return "PRON";
...
//		children=new TreeSet<Word>(s.wordComparator);
	...
	public String getAttr(WordData attr){
		...
		case HMM: return new Integer(rep[0].intValue()).toString();
	...
	public String toString() {
		return Form+"\t"+Lemma+"\t"+Lemma+"\t"+POS+"\t"+POS+"\t_\t"+Feats+"\t"+headID+"\t"+headID+"\t"+Deprel+"\t"+Deprel;//+ (rep[0]!=0.0?"\t"+rep[0]:"");
