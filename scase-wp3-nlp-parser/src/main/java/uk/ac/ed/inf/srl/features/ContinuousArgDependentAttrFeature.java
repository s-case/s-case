...
public class ContinuousArgDependentAttrFeature
        extends ContinuousAttrFeature
{
    ...
    {
        addFeatures(nonbinFeats, getFeatureString(s, predIndex, argIndex), getFeatureValue(s, predIndex, argIndex),
                offset, allWords);
    ...
    {
        addFeatures(nonbinFeats, getFeatureString(pred, arg), getFeatureValue(pred, arg), offset, allWords);
    }

    private void addFeatures(Map<Integer, Double> nonbinFeats, String featureString, Double val, Integer offset,
            boolean allWords)
    {
