...
public class ContinuousArgDependentAttrFeature extends ContinuousAttrFeature {
	...
	protected ContinuousArgDependentAttrFeature(FeatureName name, WordData attr, TargetWord tw, String POSPrefix) {
	...
	public void addFeatures(Sentence s, Collection<Integer> indices, Map<Integer, Double> nonbinFeats, int predIndex, int argIndex, Integer offset,boolean allWords) {
	    addFeatures(nonbinFeats,
			getFeatureString(s,predIndex,argIndex),
	...
	public void addFeatures(Collection<Integer> indices, Map<Integer, Double> nonbinFeats, Predicate pred,Word arg, Integer offset,boolean allWords){
	    addFeatures(nonbinFeats,
			getFeatureString(pred,arg),
			getFeatureValue(pred,arg),
			offset,allWords);
	}
    private void addFeatures(Map<Integer, Double> nonbinFeats,String featureString, Double val, Integer offset,boolean allWords){
