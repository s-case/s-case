...
public class PredDependentEmbedding
        extends ContinuousFeature
{
    ...
    protected PredDependentEmbedding(FeatureName name, TargetWord tw, boolean includeAllWords, String POSPrefix,
            WordEmbedding bc, int dim, boolean token)
    {
