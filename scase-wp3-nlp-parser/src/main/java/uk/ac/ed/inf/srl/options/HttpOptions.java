...
import uk.ac.ed.inf.srl.http.HttpPipeline;
        ...
        extends FullPipelineOptions
{
    ...
    int trySubParseArg(String[] args, int ai)
    {
        if (args[ai].equals("-port")) {
            ...
            ai++;
        } else if (args[ai].equals("-https")) { // TODO test that this works, and document this. If
                                                // people want to use HTTPS for some reason.
            ai++;
            https = true;
