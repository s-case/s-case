        ...
        implements QuadraticFeature
{
    ...
    protected QDoubleChildSetFeature(ChildSetFeature f1, ChildSetFeature f2, boolean usedForPredicateIdentification,
            String POSPrefix)
    {
        super(f1.name, f1.includeArgs && f2.includeArgs, usedForPredicateIdentification, POSPrefix); // The
                                                                                                     // boolean
                                                                                                     // should
                                                                                                     // always
                                                                                                     // evaluate
