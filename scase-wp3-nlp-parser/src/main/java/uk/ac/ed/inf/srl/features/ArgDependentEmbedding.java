...
public class ArgDependentEmbedding
        extends ContinuousFeature
{
    ...
    protected ArgDependentEmbedding(FeatureName name, TargetWord tw, String POSPrefix, boolean comp, boolean avg,
            WordEmbedding bc, int dim, boolean tokenbased)
    {
    ...
    {
        nonbinFeats.put(indexOf(getFeatureString(s, predIndex, argIndex)) + offset,
    ...
    {
        nonbinFeats.put(indexOf(getFeatureString(pred, arg)) + offset, getFeatureValue(pred, arg));
    }
