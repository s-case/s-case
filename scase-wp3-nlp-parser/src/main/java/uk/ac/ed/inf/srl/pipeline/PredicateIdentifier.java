        ...
        extends AbstractStep
{
    ...
    {
        /*
         * We add an instance if it 1) Is a predicate. Then either to its specific classifier, or
         * the fallback one. (if fallback behavior is specified, i.e.
         * skipNonMatchingPredicates=false 2) Is not a predicate, but matches the POS-tag
         */
