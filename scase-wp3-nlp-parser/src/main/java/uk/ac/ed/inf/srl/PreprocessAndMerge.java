...
public class PreprocessAndMerge
{
            ...
            throws Exception
    {
        ...
        args = new String[] { "eng", "-tokenize", "-lemma", "models/lemma-train-eng.model", "-parser",
        ...
        for (String input : new String[] { "annotations/new/restmarks.txt", "annotations/new/last126.txt",
                "annotations/new/next126.txt", "annotations/new/first60.txt" }) {
