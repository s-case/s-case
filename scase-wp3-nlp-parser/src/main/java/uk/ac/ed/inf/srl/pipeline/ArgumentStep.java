        ...
        extends AbstractStep
{
    ...
    // TODO this way we lookup the POSPrefix several times for the same predicate. Maybe the second
    // parameter should be Iterable<Word> ?
    ...
    protected void collectFeatures(Predicate pred, Word arg, String POSPrefix, Collection<Integer> indices,
